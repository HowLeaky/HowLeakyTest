    ...
    public static class DateUtilities
    {
            ...
            String shortformat, String longformat, String joiner)
        {
            try
            {
                ...
                {
                    return String.Format("{0}{1}{2}", start.ToString(shortformat), joiner, end.ToString(longformat));
                }
                else
                {
                    return String.Format("{0}{1}{2}", start.ToString(longformat), joiner, end.ToString(longformat));
                }
            }
            catch (Exception ex)
            {
